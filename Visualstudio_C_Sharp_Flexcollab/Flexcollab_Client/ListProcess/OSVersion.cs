...
namespace CommonOfProcessList
{
	...
	public class OSVersionInfo : IComparable, ICloneable
	{
		...
		private static readonly OSVersionInfo _Win32s   = new OSVersionInfo( CommonOfProcessList.OSPlatformId.Win32s       , MajorVersionConst.Win32s   , MinorVersionConst.Win32s   , true );
		private static readonly OSVersionInfo _Win95    = new OSVersionInfo( CommonOfProcessList.OSPlatformId.Win32Windows , MajorVersionConst.Win95    , MinorVersionConst.Win95    , true );
		private static readonly OSVersionInfo _Win98    = new OSVersionInfo( CommonOfProcessList.OSPlatformId.Win32Windows , MajorVersionConst.Win98    , MinorVersionConst.Win98    , true );
		private static readonly OSVersionInfo _WinME    = new OSVersionInfo( CommonOfProcessList.OSPlatformId.Win32Windows , MajorVersionConst.WinME    , MinorVersionConst.WinME    , true );
		private static readonly OSVersionInfo _WinNT351 = new OSVersionInfo( CommonOfProcessList.OSPlatformId.Win32NT      , MajorVersionConst.WinNT351 , MinorVersionConst.WinNT351 , true );
		private static readonly OSVersionInfo _WinNT4   = new OSVersionInfo( CommonOfProcessList.OSPlatformId.Win32NT      , MajorVersionConst.WinNT4   , MinorVersionConst.WinNT4   , true );
		private static readonly OSVersionInfo _Win2000  = new OSVersionInfo( CommonOfProcessList.OSPlatformId.Win32NT      , MajorVersionConst.Win2000  , MinorVersionConst.Win2000  , true );
		private static readonly OSVersionInfo _WinXP    = new OSVersionInfo( CommonOfProcessList.OSPlatformId.Win32NT      , MajorVersionConst.WinXP    , MinorVersionConst.WinXP    , true );
		private static readonly OSVersionInfo _Win2003  = new OSVersionInfo( CommonOfProcessList.OSPlatformId.Win32NT      , MajorVersionConst.Win2003  , MinorVersionConst.Win2003  , true );
		private static readonly OSVersionInfo _WinCE    = new OSVersionInfo( CommonOfProcessList.OSPlatformId.WinCE        , true ); // TODO: WinCE version
		...
		public CommonOfProcessList.OSPlatformId OSPlatformId
		{
		...
		public CommonOfProcessList.OSSuites OSSuiteFlags
		{
			get
			{
		...
		public CommonOfProcessList.OSProductType OSProductType
		{
			get
			{
		...
		public string OSPlatformIdString
		{
			get
			{
				switch ( OSPlatformId )
				{
					case CommonOfProcessList.OSPlatformId.Win32s       : return "Windows 32s";
					case CommonOfProcessList.OSPlatformId.Win32Windows : return "Windows 32";
					case CommonOfProcessList.OSPlatformId.Win32NT      : return "Windows NT";
					case CommonOfProcessList.OSPlatformId.WinCE        : return "Windows CE";
		...
		public static bool OSSuiteFlag( CommonOfProcessList.OSSuites flags, CommonOfProcessList.OSSuites test )
		{
			return ( ( flags & test ) > 0 );
		}
		...
		public string OSSuiteString
		{
			get
			{
				...
				CommonOfProcessList.OSSuites flags = OSSuiteFlags;

				if ( OSSuiteFlag( flags, CommonOfProcessList.OSSuites.SmallBusiness ) )
					OSSuiteStringAdd( ref s, "Small Business" );

				if ( OSSuiteFlag( flags, CommonOfProcessList.OSSuites.Enterprise ) )
					switch ( OSVersion )
					{
						case CommonOfProcessList.OSVersion.WinNT4  : OSSuiteStringAdd( ref s, "Enterprise" ); break;
						case CommonOfProcessList.OSVersion.Win2000 : OSSuiteStringAdd( ref s, "Advanced"   ); break;
						case CommonOfProcessList.OSVersion.Win2003 : OSSuiteStringAdd( ref s, "Enterprise" ); break;
					}

				if ( OSSuiteFlag( flags, CommonOfProcessList.OSSuites.BackOffice ) )
					OSSuiteStringAdd( ref s, "BackOffice" );

				if ( OSSuiteFlag( flags, CommonOfProcessList.OSSuites.Communications ) )
					OSSuiteStringAdd( ref s, "Communications" );

				if ( OSSuiteFlag( flags, CommonOfProcessList.OSSuites.Terminal ) )
					OSSuiteStringAdd( ref s, "Terminal Services" );

				if ( OSSuiteFlag( flags, CommonOfProcessList.OSSuites.SmallBusinessRestricted ) )
					OSSuiteStringAdd( ref s, "Small Business Restricted" );

				if ( OSSuiteFlag( flags, CommonOfProcessList.OSSuites.EmbeddedNT ) )
					OSSuiteStringAdd( ref s, "Embedded" );

				if ( OSSuiteFlag( flags, CommonOfProcessList.OSSuites.Datacenter ) )
					OSSuiteStringAdd( ref s, "Datacenter" );

				//				if ( OSSuiteFlag( flags, CommonOfProcessList.OSSuites.SingleUserTS ) )
				//					OSSuiteStringAdd( ref s, "Single User Terminal Services" );

				if ( OSSuiteFlag( flags, CommonOfProcessList.OSSuites.Personal ) )
					OSSuiteStringAdd( ref s, "Home Edition" );

				if ( OSSuiteFlag( flags, CommonOfProcessList.OSSuites.Blade ) )
					OSSuiteStringAdd( ref s, "Web Edition" );

				if ( OSSuiteFlag( flags, CommonOfProcessList.OSSuites.EmbeddedRestricted ) )
		...
		public string OSProductTypeString
		{
			get
			{
				...
				{
					case CommonOfProcessList.OSProductType.Workstation:

					switch ( OSVersion )
					{
						case CommonOfProcessList.OSVersion.Win32s   : return String.Empty;
						case CommonOfProcessList.OSVersion.Win95    : return String.Empty;
						case CommonOfProcessList.OSVersion.Win98    : return String.Empty;
						case CommonOfProcessList.OSVersion.WinME    : return String.Empty;
						case CommonOfProcessList.OSVersion.WinNT351 : return String.Empty;
						case CommonOfProcessList.OSVersion.WinNT4   : return "Workstation";
						case CommonOfProcessList.OSVersion.Win2000  : return "Professional";

						case CommonOfProcessList.OSVersion.WinXP    :

							if ( OSSuiteFlag( OSSuiteFlags, CommonOfProcessList.OSSuites.Personal ) )
								return "Home Edition";
							else
								return "Professional";

						case CommonOfProcessList.OSVersion.Win2003  : return String.Empty;
						case CommonOfProcessList.OSVersion.WinCE    : return String.Empty;

						default: throw new InvalidOperationException( "Invalid OSVersion: " + OSVersion );
					}

					case CommonOfProcessList.OSProductType.DomainController:
					{
					...
					case CommonOfProcessList.OSProductType.Server:
					{
						string s = OSSuiteString;
		...
		public CommonOfProcessList.OSVersion OSVersion
		{
			get
			{
				switch ( OSPlatformId )
				{
					case CommonOfProcessList.OSPlatformId.Win32s: return CommonOfProcessList.OSVersion.Win32s;

					case CommonOfProcessList.OSPlatformId.Win32Windows:

					switch ( OSMinorVersion )
					{
						case MinorVersionConst.Win95: return CommonOfProcessList.OSVersion.Win95;
						case MinorVersionConst.Win98: return CommonOfProcessList.OSVersion.Win98;
						case MinorVersionConst.WinME: return CommonOfProcessList.OSVersion.WinME;

						default: throw new InvalidOperationException( "Invalid Win32Windows MinorVersion: " + OSMinorVersion );
					}

					case CommonOfProcessList.OSPlatformId.Win32NT:

					switch ( OSMajorVersion )
					{
						case MajorVersionConst.WinNT351 : return CommonOfProcessList.OSVersion.WinNT351 ;
						case MajorVersionConst.WinNT4   : return CommonOfProcessList.OSVersion.WinNT4   ;

						case MajorVersionConst.WinNT5   :
						
						switch ( OSMinorVersion )
						{
							case MinorVersionConst.Win2000 : return CommonOfProcessList.OSVersion.Win2000 ;
							case MinorVersionConst.WinXP   : return CommonOfProcessList.OSVersion.WinXP   ;
							case MinorVersionConst.Win2003 : return CommonOfProcessList.OSVersion.Win2003 ;
					...
					case CommonOfProcessList.OSPlatformId.WinCE: return CommonOfProcessList.OSVersion.WinCE;
		...
		public string OSVersionString
		{
			get
			{
				switch ( OSVersion )
				{
					case CommonOfProcessList.OSVersion.Win32s   : return "Windows 32s";
					case CommonOfProcessList.OSVersion.Win95    : return "Windows 95";
					case CommonOfProcessList.OSVersion.Win98    : return "Windows 98";
					case CommonOfProcessList.OSVersion.WinME    : return "Windows ME";
					case CommonOfProcessList.OSVersion.WinNT351 : return "Windows NT 3.51";
					case CommonOfProcessList.OSVersion.WinNT4   : return "Windows NT 4";
					case CommonOfProcessList.OSVersion.Win2000  : return "Windows 2000";
					case CommonOfProcessList.OSVersion.WinXP    : return "Windows XP";
					case CommonOfProcessList.OSVersion.Win2003  : return "Windows 2003";
					case CommonOfProcessList.OSVersion.WinCE    : return "Windows CE";
	...
	public class OperatingSystemVersion : OSVersionInfo
	{
		...
		private static CommonOfProcessList.OSPlatformId GetOSPlatformId( int platformId )
		{
			switch ( platformId )
			{
				case VerPlatformId.Win32s       : return CommonOfProcessList.OSPlatformId.Win32s       ;
				case VerPlatformId.Win32Windows : return CommonOfProcessList.OSPlatformId.Win32Windows ;
				case VerPlatformId.Win32NT      : return CommonOfProcessList.OSPlatformId.Win32NT      ;
				case VerPlatformId.WinCE        : return CommonOfProcessList.OSPlatformId.WinCE        ;

				default: throw new InvalidOperationException( "Invalid PlatformId: " + platformId );
			}
		}

		private static CommonOfProcessList.OSSuites GetOSSuiteFlags( UInt16 suiteMask )
		{
			return ( CommonOfProcessList.OSSuites ) suiteMask;
		}

		private static CommonOfProcessList.OSProductType GetOSProductType( byte productType )
		{
			switch ( productType )
			{
				case VerProductType.VER_NT_WORKSTATION       : return CommonOfProcessList.OSProductType.Workstation      ;
				case VerProductType.VER_NT_DOMAIN_CONTROLLER : return CommonOfProcessList.OSProductType.DomainController ;
				case VerProductType.VER_NT_SERVER            : return CommonOfProcessList.OSProductType.Server           ;
