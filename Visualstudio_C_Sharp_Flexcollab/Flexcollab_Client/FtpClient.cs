...
namespace WebMeeting.FTP
{

	public class FtpClient
	{
		public delegate void OnStatusUpdate(int nPercent);
		...
		public OnStatusUpdate OnDirectoryStatusFunction;
		...
		public void Login()
		{
			...
			catch(Exception ex)
			{
				...
				//System.Windows.Forms.MessageBox.Show("Couldn't connect to remote server, Contact Support");

				throw new FtpException("Couldn't connect to remote server, Contact Support",ex);
			}
		...
		public void UploadDirectory(string path, bool recurse, string mask)
		{
			...
			this.ChangeDir(rootDir);
				...
				{
					if(OnDirectoryStatusFunction != null)
						OnDirectoryStatusFunction(nCount);
