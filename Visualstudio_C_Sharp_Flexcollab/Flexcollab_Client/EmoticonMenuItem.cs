...
namespace IMWindow {
	...
	public class EmoticonMenuItem : MenuItem {
		...
		protected override void OnMeasureItem(MeasureItemEventArgs _args) {
			_args.ItemWidth = Win32.USER32.ICON_WIDTH + Win32.USER32.ICON_MARGIN;
			_args.ItemHeight =Win32.USER32.ICON_HEIGHT + 2 * Win32.USER32.ICON_MARGIN;
		}
		...
		protected override void OnDrawItem(DrawItemEventArgs _args) {
			...
			_graphics.DrawImage(image, _bounds.X + ((_bounds.Width - Win32.USER32.ICON_WIDTH) / 2), _bounds.Y + ((_bounds.Height - Win32.USER32.ICON_HEIGHT) / 2));
		}
